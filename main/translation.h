...
static const translation cz_en[] = {
    {"Vypnuto", "Off"},
    {"automato 1.0. Úpravy funkčnosti při změně formátu vstupních dat OTE nebo jiných změnách provozních podmínek jsou "
     "řešeny v rámci zakoupené podpory.",
    ...
    {"Operátor", "Operator"},
    {"Podmínka", "Condition"},
    {"Nastavení podmínek a akcí", "Conditions and actions settings"},
    {"Potvrzení", "Confirm"},
    {"Nastavení", "Setup"},
    {"Akce", "Actions"},
    {"po", "Mon"},
    ...
    {"Pozor, stiskem tlačítka níže změníte všechna nastavení na výchozí a "
     "restartujete zařízení (nutno znovu připojit na wifi)",
